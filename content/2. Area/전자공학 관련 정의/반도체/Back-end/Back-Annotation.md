...
Back-annotation은 [[Setup&Hold Violation Check|setup/hold timing violation]] 검출, functional verification, power estimation, yield optimization 등 최종 [[Sign-off|sign-off]] 단계에서 핵심적인 역할을 수행한다. 정확한 delay 정보를 기반으로 함으로써, **overly possimistic design margin**을 줄이고 **성능 최적화**를 달성할 수 있다.
