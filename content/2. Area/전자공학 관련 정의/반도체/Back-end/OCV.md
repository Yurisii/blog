# On Chip Variation
반도체 칩 내부에서 발생할 수 있는 **PVT** 변화에 의한 Delay의 변동성을 고려하여 **[[STA(Static Timing Analysis)]]**에서 더 정확하고 안전하게 설계 타이밍을 검증하기 위한 보수적 분석 기법이다.
...
그래서 **OCV는 경로별 delay에 margin을 추가해서 worst-case 상황을 안전하게 가정**함.
